<?php
/**
 * Defines the TOL_API_Collection class
 *
 * @package TOL_API
 */
...
/**
 * Class for iterating index response to the TOL API. Collections are readonly
 *
 * @package TOL_API
 */
final class TOL_API_Collection implements Iterator, Countable
{
    /**
     * API Client
     *
     ...
     *
     * @param TOL_API_Client $client client connection to the API
     * @param string $resource name of API resource to request
     * @param array $filters key value pair array of search filters
     */
    public function __construct(TOL_API_Client $client, $resource, array $filters = array())
    {
    ...
    public function next()
    {
        ...
        Util::ensure(200, $httpCode, 'TOL_API_Exception', array("Did not receive 200 from API. Instead received {$httpCode}"));
